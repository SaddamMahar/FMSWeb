    ...
    <body>
        ...
        <main>
            <section class="contentSec">
                ...
                <div class="btnHolder">
                    <a href="http://localhost:8085/FuelManagementSystem/products/add">
                        <i></i>Go to Add Product page
                    </a>
                </div>
                            ...
                            <c:if test="${not empty productList}">
                                <c:forEach var="listValue" items="${productList}">                                
                                    <tr>
                                        ...
                                        <td>${listValue.saleRate}</td>
                                        <td>
                                            <a href="http://localhost:8085/FuelManagementSystem/products/Edit/${listValue.productID}">Edit</a>
                                            <a href="http://localhost:8085/FuelManagementSystem/products/delete/${listValue.productID}">Delete</a>
                                        </td>
                                    </tr>
                                </c:forEach>
                            </c:if>
